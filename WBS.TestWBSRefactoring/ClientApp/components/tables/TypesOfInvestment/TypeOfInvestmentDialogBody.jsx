...
class TypeOfInvestmentDialogBody extends React.PureComponent {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        const { code, title, externalCode } = this.state;
        const { code: codeName, title: titleName, externalCode: externalCodeName } = formFields;
        ...
        return (
            <>
                ...
                <TextFieldPlaceholder
                    muProps={{
                        name: externalCodeName.propName,
                        label: externalCodeName.label,
                        value: externalCode,
                        type: "number",
                        onChange: this.handleChange,
                        fullWidth: true
...
export default TypeOfInvestmentDialogBody;
